...
(() => {
  ...
  var wt = (s, o) => () => (
    o || s((o = { exports: {} }).exports, o), o.exports
  );
  var Ct = (s, o, n, r) => {
    if ((o && typeof o == "object") || typeof o == "function")
      for (let e of ht(o))
        !Rt.call(s, e) &&
          ...
          q(s, e, {
            get: () => o[e],
            enumerable: !(r = _t(o, e)) || r.enumerable,
          });
    return s;
  };
  var Ut = (s, o, n) => (
      ...
      return (function () {
        var s = {
            686: function (r, e, t) {
              ...
              function Et(p, u) {
                return u && (I(u) === "object" || typeof u == "function")
                  ? u
                  : At(p);
              }
              function At(p) {
                ...
                off: function (t, c) {
                  ...
                  if (d && c)
                    for (var T = 0, x = d.length; T < x; T++)
                      d[T].fn !== c && d[T].fn._ !== c && y.push(d[T]);
  ...
  var Lt = `${g}-support`,
    Nt =
      "/cdn.jsdelivr.net/npm/@finsweet/attributes-support@1/support.js",
    Q = async () => {
  ...
  var W = (s) => (o) => `${s}${o ? `-${o}` : ""}`,
    O = (s) => {
      let o = (r, e, t) => {
        ...
        typeof T == "string"
          ? (y = T)
          : (y = T(t && "instanceIndex" in t ? t.instanceIndex : void 0));
  ...
  var Z = (s) => {
    ...
    let e = {
      preventsLoad: typeof o.getAttribute(R.preventLoad.key) == "string",
      attributes: n,
    };
    for (let t in s) {
  ...
  var et = ({ scriptAttributes: s, attributeKey: o, version: n, init: r }) => {
    ...
    Ot = () => {
      ...
      let o = {
        ...
        push(...n) {
          var r, e;
          for (let [t, c] of n)
            (e = (r = this[t]) == null ? void 0 : r.loading) == null ||
              e.then(c);
        },
        destroy() {
          var n, r;
          for (let e of s)
            (r = (n = window.fsAttributes[e]) == null ? void 0 : n.destroy) ==
              null || r.call(n);
        },
      };
      tt(o, s),
        Bt(o),
        (window.fsAttributes = o),
    ...
    Pt = () => {
      let s = F("src", "finsweet", { operator: "contains" }),
        o = F("dev");
      return [...document.querySelectorAll(`script${s}, script${o}`)].reduce(
        (e, t) => {
          var a;
          let c =
            t.getAttribute(R.dev.key) ||
            ((a = t.src.match(/[\w-. ]+(?=(\.js)$)/)) == null ? void 0 : a[0]);
  ...
  var h = `fs-${_}`,
    ...
    $ = {
      element: {
        key: `${h}-element`,
        values: { trigger: kt, target: W(Kt), sibling: Vt },
      },
      text: { key: `${h}-${Dt}` },
  ...
  var ut = Ut(ct(), 1),
    at = ({
      ...
      let d = new ut.default(s, {
          text: () =>
            o ||
            (n ? (V(n) ? n.value : n.textContent || "") : s.textContent || ""),
        }),
        y = !1;
      return (
        d.on("success", (T) => {
          ...
          let r = n.getAttribute(Gt),
            ...
            y =
              ((A = n.parentElement) == null
                ? void 0
                : A.querySelector(
                    ot("element", "sibling", { operator: "prefixed" })
                  )) || j("target", { instanceIndex: a }),
            T = N(n),
